...
```shell
curl -d '{"jsonrpc":"2.0","method":"on_getblockhash","params":[123456]}' http://localhost:2086/json_rpc
```
...
```shell
curl -d '{"jsonrpc":"2.0","method":"getblocktemplate","params":{"reserve_size":200,"wallet_address":"abLocxxxx..."}}' http://localhost:2086/json_rpc
```
...
```shell
curl -d '{"jsonrpc":"2.0","method":"submitblock","params":["0100b...."]}' https://localhost:2086/json_rpc
```
...
<?php
$blockBlob = '0100b...';
$response = $blocd->submitBlock($blockBlob);
echo $response;
```
...
```shell
curl -d '{"jsonrpc":"2.0","method":"getlastblockheader","params":{}}' http://localhost:2086/json_rpc
```
...
```shell
curl -d '{"jsonrpc":"2.0","method":"getblockheaderbyhash","params":{"hash":"30706..."}}' http://localhost:2086/json_rpc
```
...
```shell
curl -d '{"jsonrpc":"2.0","method":"getblockheaderbyheight","params":{"height":123456}}' http://localhost:2086/json_rpc
```
...
<?php
$height = 123456;
$response = $blocd->getBlockHeaderByHeight($height);
echo $response;
```
...
```shell
curl -d '{"jsonrpc":"2.0","method":"getcurrencyid","params":{}}' http://localhost:2086/json_rpc
```
...
```shell
curl -d '{"jsonrpc":"2.0","method":"f_blocks_list_json","params":{"height":500000}}' http://localhost:2086/json_rpc
```
...
```shell
curl -d '{"jsonrpc":"2.0","method":"f_block_json","params":{"hash":"980ff..."}}' http://localhost:2086/json_rpc
```
...
```shell
curl -d '{"jsonrpc":"2.0","method":"f_transaction_json","params":{"hash":"702ad..."}}' http://localhost:2086/json_rpc
```
...
```shell
curl -d '{"jsonrpc":"2.0","method":"f_on_transactions_pool_json","params":{}}' http://localhost:2086/json_rpc
```
